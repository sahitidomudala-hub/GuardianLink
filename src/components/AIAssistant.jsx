...
const AIAssistant = ({ student }) => {
    ...
    const askAI = async () => {
        ...
        if (!apiKey || apiKey === 'AIzaSyDMpF2Megmz7arQqexzvF_wRnNrv7DvAQQ' || apiKey === '') {
...
`;
        ...
        try {
            // Use the latest supported Gemini 1.5 Flash model
        ...
        <div className="ai-assistant-container" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                ...
                <div>
                    ...
                    <span style={{ fontSize: '12px', color: '#666' }}>Powered by Gemini 1.5 Flash</span>
                </div>
            </div>
            ...
            <div className="flex-responsive" style={{ gap: '12px', marginBottom: '20px' }}>
                <input
                    type="text"
